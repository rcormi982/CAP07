...
public class EJ10Bi {
    ...
    public static void mostrarTablero(String[][] tablero, String nombreFila) {
        System.out.println(" -------------");
        for (int i = 0; i < 3; i++) {
    ...
    public static void main(String[] args) {
        ...
        do {
            // pinta el tablero
            mostrarTablero(tablero, nombreFila);
            ...
            if (!jugadorGana && (movimientos < 9)) {
                ...
                ordenadorGana = ((tablero[0][0] == ORDENADOR) && (tablero[0][1] == ORDENADOR)
                        && (tablero[0][2] == ORDENADOR) || (tablero[1][0] == ORDENADOR) && (tablero[1][1] == ORDENADOR)
                        && (tablero[1][2] == ORDENADOR) || (tablero[2][0] == ORDENADOR) && (tablero[2][1] == ORDENADOR)
                        && (tablero[2][2] == ORDENADOR) || (tablero[0][0] == ORDENADOR) && (tablero[1][0] == ORDENADOR)
                        && (tablero[2][0] == ORDENADOR) || (tablero[0][1] == ORDENADOR) && (tablero[1][1] == ORDENADOR)
                        && (tablero[2][1] == ORDENADOR) || (tablero[0][2] == ORDENADOR) && (tablero[1][2] == ORDENADOR)
                        && (tablero[2][2] == ORDENADOR) || (tablero[0][0] == ORDENADOR) && (tablero[1][1] == ORDENADOR)
                        && (tablero[2][2] == ORDENADOR) || (tablero[0][2] == ORDENADOR) && (tablero[1][1] == ORDENADOR)
